              ...
              <div class="flex flex-col justify-end gap-4 md:gap-6 px-4 py-6 md:py-10 lg:py-20">
                ...
                <div class="flex flex-1 justify-center">
                  <div class="flex flex-col sm:flex-row justify-center gap-3 md:gap-4 w-full max-w-md">
                    @auth
                      <a href="{{ route('dashboard') }}"
                        class="flex min-w-[120px] cursor-pointer items-center justify-center overflow-hidden rounded-full h-12 px-6 bg-[#dce8f3] text-[#121416] text-sm md:text-base font-bold leading-normal tracking-[0.015em] grow"
                      >
                        <span class="truncate">Vai alla Dashboard</span>
                      </a>
                    @else
